...
cartsvc_ = rossvcclient('/dobot_magician/PTP/set_cartesian_pos');
cartmsg_ = rosmessage(cartsvc_);
cartmsg_.TargetPoints=[0.31,0.105,-0.06,0];
cartsvc_.call(cartmsg_)
%pause;
% top right point
...
cartsvc_ = rossvcclient('/dobot_magician/PTP/set_cartesian_pos');
cartmsg_ = rosmessage(cartsvc_);
cartmsg_.TargetPoints=[0.31,-0.095,-0.06,0];
cartsvc_.call(cartmsg_)
%pause;
% bottom left point
...
cartsvc_ = rossvcclient('/dobot_magician/PTP/set_cartesian_pos');
cartmsg_ = rosmessage(cartsvc_);
cartmsg_.TargetPoints=[0.165,0.105,-0.06,0];
cartsvc_.call(cartmsg_)
%pause();
% bottom right point
...
cartsvc_ = rossvcclient('/dobot_magician/PTP/set_cartesian_pos');
cartmsg_ = rosmessage(cartsvc_);
cartmsg_.TargetPoints=[0.165,-0.095,-0.06,0];
cartsvc_.call(cartmsg_)
%pause();